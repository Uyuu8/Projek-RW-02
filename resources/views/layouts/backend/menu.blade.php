...
<div class="main-menu menu-fixed menu-dark menu-accordion menu-shadow" data-scroll-to-active="true">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item {{ request()->is('backend-warga*') ? 'active' : '' }}">
                <a class="d-flex align-items-center" href="{{ route('backend-warga.index') }}">
                    <i data-feather="users"></i>
                    <span class="menu-item text-truncate" data-i18n="Basic">Data Warga</span>
                </a>
            </li>

            <li class="nav-item {{ request()->is('backend-pengguna-user*') ? 'active' : '' }}">
                <a class="d-flex align-items-center" href="{{ route('backend-pengguna-user.index') }}">
                    <i data-feather="user-check"></i>
                    <span class="menu-item text-truncate" data-i18n="Basic">Manajemen User</span>
                </a>
            </li>
...
'Admin','Ketua RW','Sekretaris','Bendahara','Tarka'